    ...
    <>
      ...
      >
        <main className="min-h-screen bg-[#1c1c1c]">
          {/* HERO */}
          <section className="relative min-h-[90vh] bg-linear-to-b from-[#0f0f14] to-[#1c1c1c] overflow-hidden flex items-center">
            {/* Glow effects */}
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
              <h1 className="text-4xl md:text-6xl font-semibold tracking-wide uppercase mb-6">
                Prepare-se para{" "}
                <span className="bg-linear-to-r from-[#FF7272] to-red-500 bg-clip-text text-transparent font-bold tracking-wider">
                  escolher seu lado
                </span>
              </h1>
